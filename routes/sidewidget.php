...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/favourites', [OfferController::class, 'favouritesPage'])->name('favourites');
    Route::delete('/favourites/{favourite}', [OfferController::class, 'favouritesDestroy'])->name('favourites.destroy');
});
