                ...
                <div class="mt-9 dark:bg-gray-900 rounded-lg border-[1px] border-gray-300 dark:border-0 p-3">
                    ...
                    <ul>
                        @foreach($employments as $employment)
                            <li>
                                <input type="checkbox" wire:model="filterEmployments" value="{{$employment->name}}" class="rounded-md text-orange-600 dark:checked:bg-orange-500 bg-white
                ...
                <div class="mt-9 dark:bg-gray-900 rounded-lg border-[1px] border-gray-300 dark:border-0 p-3">
                    ...
                    <ul>
                        @foreach($contracts as $contract)
                            <li>
                                <input type="checkbox" wire:model="filterContracts" value="{{$contract->name}}" class="rounded-md text-orange-600 dark:checked:bg-orange-500 bg-white
                            dark:bg-gray-900 ring-offset-0 focus:ring-orange-500 dark:ring-offset-gray-800">
                ...
                <div class="mt-9 dark:bg-gray-900 rounded-lg border-[1px] border-gray-300 dark:border-0 p-3">
                    ...
                    <ul>
                        @foreach($workmodes as $workmode)
                            <li>
                                <input type="checkbox" wire:model="filterWorkmodes" value="{{$workmode->name}}" class="rounded-md text-orange-600 dark:checked:bg-orange-500 bg-white
                            dark:bg-gray-900 ring-offset-0 focus:ring-orange-500 dark:ring-offset-gray-800">
