<div class=" dark:bg-gray-900 h-48 mt-6 hover:text-gray-300 rounded-lg">
    <a href="{{route('sidewidgets.show', $offer)}}">
        <div class="p-2 gap-4">
            <div class="pb-1 pl-2 flex items-center">
                ...
                <h3 class="w-1/4 text-gray-600 dark:text-gray-400">@if($offer->salary) {{$offer->salary}} zł/ @if($offer->payment_id){{$offer->payment->name}}@endif @else Wypłata do ustalenia @endif</h3>
            </div>
