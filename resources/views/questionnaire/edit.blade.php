        ...
        <form method="POST" action="{{ route('questionnaire.update') }}">
            ...
            <div class="flex flex-col items-center">
                <div class="bg-white dark:bg-gray-800/50">
                    ...
                    <x-text-input id="name" class="block mt-1 w-full" type="text" value="{{$questionnaire->name}}" name="name" :value="old('name')"
                ...
                <div class="bg-white d ark:bg-gray-800/50">
                    ...
                    <select name="offer" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500
